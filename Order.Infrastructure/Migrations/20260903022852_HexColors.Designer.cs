...
namespace Order.Infrastructure.Migrations
{
    ...
    [Migration("20260903022852_HexColors")]
    partial class HexColors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Order.Domain.Entities.BookingColor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BookingColor");
                });

            modelBuilder.Entity("Order.Domain.Entities.BookingProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Order.Domain.Entities.BookingReminderLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BookingId", "ReminderConfigId")
                        .IsUnique();

                    b.ToTable("BookingReminderLog");
                });
            ...
            modelBuilder.Entity("Order.Domain.Entities.BookingTechnicianService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("BookingTechnicianId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BookingTechnicianId");

                    b.ToTable("BookingTechnicianService");
                });
            ...
            modelBuilder.Entity("Order.Domain.Entities.NotificationRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Order.Domain.Entities.PaymentProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Order.Domain.Entities.PaymentProviderSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Order.Domain.Entities.ReminderConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ReminderConfig");
                });

            modelBuilder.Entity("Order.Domain.Entities.TipAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Order.Domain.Entities.BookingReminderLog", b =>
                {
                    ...
                    b.HasOne("Order.Domain.Entities.ReminderConfig", "ReminderConfig")
                        .WithMany()
            ...
            modelBuilder.Entity("Order.Domain.Entities.BookingTechnicianService", b =>
                {
                    b.HasOne("Order.Domain.Entities.BookingTechnician", "BookingTechnician")
                        .WithMany("Services")
                        .HasForeignKey("BookingTechnicianId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BookingTechnician");
                });
            ...
            modelBuilder.Entity("Order.Domain.Entities.NotificationRecipient", b =>
                {
                    b.HasOne("Order.Domain.Entities.Notification", "Notification")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("Order.Domain.Entities.PaymentProviderSetting", b =>
                {
                    b.HasOne("Order.Domain.Entities.PaymentProvider", "PaymentProvider")
                        .WithMany("PaymentProviderSettings")
            ...
            modelBuilder.Entity("Order.Domain.Entities.PaymentProvider", b =>
                {
                    b.Navigation("PaymentProviderSettings");
                });
