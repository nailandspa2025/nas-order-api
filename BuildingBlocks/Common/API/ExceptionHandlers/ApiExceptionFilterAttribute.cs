...
namespace BuildingBlocks.Common.API.ExceptionHandlers;
...
public class ApiExceptionFilterAttribute: ExceptionFilterAttribute
{
    ...
    private void HandleValidationException(ExceptionContext context)
    {
        ...
        var apiResponse = ApiResponse.Error(exception.ErrorMessages.FirstOrDefault() ?? string.Empty);
    ...
    private void HandleInvalidOperationException(ExceptionContext context)
    {
        ...
        var apiResponse = ApiResponse.Error(exception.Message);
        context.Result = new OkObjectResult(apiResponse);
        context.ExceptionHandled = true;
    }
